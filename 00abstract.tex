...
% Applying traditional methods of matching entities with long sequences of textual data is challenging and expensive. \vt{delete this sentence from abs}
...
% \vt{except for the dataset with highly domain-specific knowledge}
% \vt{scientific bibliographic data vs general domain knowledge}
% \vt{fix all the 'we' sentences}