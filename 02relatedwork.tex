\begin{figure*}[!ht]
    ...
    Then three options of prompting types are provided after external knowledge injection: (1) using space; (2) using ``/''; (3) using \cam{constrained tuning \st{additional position encoding}}. 
